        ...
        <div className={styles.sectionOpposite}>
          ...
          <div style={{ width: '50%', padding: '10px' }}>
            ...
            <div className={styles.paragraphfifty}>
              ...
              sets strict guidelines for storing and security PHI. Healthcare IT
              services from Galaxy IT can provide security to protect your
              practice’s critical data while also keeping day-to-day IT
              operations running flawlessly. With a secure network
              infrastructure, you can be confident knowing that protected health
